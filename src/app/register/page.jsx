...
<form className=" flex-[3] flex items-center justify-center w-full  ">
    ...
    <h1 class="mb-4 text-3xl font-normal capitalize text-center leading-none tracking-tight text-gray-900   dark:text-white">Create an account</h1>
  <div className="mb-5">
   
    <input type="email" id="email" className="bg-gray-50 border outline-none  border-gray-300 placeholder:uppercase text-gray-900 text-sm rounded-lg  block w-full p-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="email" required />
  </div>
  <div className="mb-5">
  ...
  <Link href={"/login"} className='text-gray-500 underline'>Do have an account?</Link>
  </div>
</form>
